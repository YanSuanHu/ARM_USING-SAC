    ...
    for episode_i in range(max_episodes):
        ...
        for t in range(max_timesteps):
            ...
            if t<=10:
                ...
                dx =(1- new_pos[0])/40*(t-120)+new_pos[0]-end_effector_pos[0]
                dy = (0- new_pos[1])/40*(t-120)+new_pos[1]-end_effector_pos[1]
                dz = (-new_pos[2]/2)/40*(t - 120) + new_pos[2] - end_effector_pos[2]
